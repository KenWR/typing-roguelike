...
export const ENEMY_CONFIGS = [
  createEnemyConfig({
    ...
    attackDamage: 7,
    attackWindupMs: 1800,
    attackDescription: "다음 입력 제한시간 20% 감소",
  }),
  createEnemyConfig({
    id: "hook-tentacle",
    name: "갈고리 촉수",
    ...
    attackDamage: 11,
    attackWindupMs: 1400,
    attackDescription: "다음 플레이어 후딜 200ms 증가",
  }),
  createEnemyConfig({
    id: "iron-beetle",
    name: "철갑 갑충",
    ...
    role: "defense",
    hp: 72,
    allowedFloors: [2, 3, 4, 5],
    attackDamage: 13,
    attackWindupMs: 2000,
    attackDescription: "갑각을 열고 공격",
  }),
  createEnemyConfig({
    id: "bell-wraith",
    name: "종소리 망령",
  ...
  createEnemyConfig({
    ...
    role: "disruption",
    hp: 52,
    allowedFloors: [3, 4, 5, 6],
    attackDamage: 12,
    attackWindupMs: 1500,
    attackDescription: "다음 커맨드 역순",
  }),
  createEnemyConfig({
    id: "space-eater",
    name: "공백 포식자",
  ...
  createEnemyConfig({
    ...
    role: "pressure",
    hp: 60,
    allowedFloors: [2, 3, 4, 5, 6, 7],
    attackDamage: 16,
    attackWindupMs: 1200,
    attackDescription: "긴 투사체",
  }),
  createEnemyConfig({
    id: "red-scribe",
    name: "붉은 필경사",
    ...
    role: "support",
    hp: 66,
    allowedFloors: [3, 4, 5, 6, 7, 8],
    attackDamage: 9,
    attackWindupMs: 2000,
    attackDescription: "아군 게이지 가속",
  }),
  createEnemyConfig({
    id: "repair-golem",
    name: "수복 골렘",
    ...
    role: "support",
    hp: 108,
    allowedFloors: [5, 6, 7, 8],
    attackDamage: 15,
    attackWindupMs: 2200,
    attackDescription: "아군 회복",
  }),
  createEnemyConfig({
    id: "explosive-spore",
    name: "폭발 포자",
    ...
    role: "execution",
    hp: 42,
    allowedFloors: [5, 6, 7, 8, 9],
    attackDamage: 22,
    attackWindupMs: 1400,
    attackDescription: "처치 후 폭발",
  }),
  createEnemyConfig({
    id: "chain-executor",
    name: "사슬 집행자",
    ...
    role: "defense",
    hp: 126,
    allowedFloors: [6, 7, 8, 9],
    attackDamage: 18,
    attackWindupMs: 1900,
    attackDescription: "대상 고정",
  }),
  createEnemyConfig({
    id: "mirror-doll",
    name: "거울 인형",
  ...
  createEnemyConfig({
    ...
    specials: [
      ...
      },
      {
        ...
        windupMs: 2700,
        recoveryMs: 900,
        description: "플레이어의 입력 규칙을 교정합니다.",
      },
    ],
  }),
  createEnemyConfig({
    id: "thousand-beat-chorus",
    name: "천 개의 박자 합창체",
    tier: "boss",
    role: "pressure",
    hp: 630,
