...
export const ENEMY_CONFIGS = [
  createEnemyConfig({ id: "ink-slime", name: "먹물 슬라임", tier: "normal", role: "disruption", hp: 34, allowedFloors: [1, 2, 3], attackDamage: 7, attackWindupMs: 5400, attackDescription: "다음 입력 제한시간 20% 감소", specialName: "먹물 압착" }),
  createEnemyConfig({ id: "hook-tentacle", name: "갈고리 촉수", tier: "normal", role: "pressure", hp: 46, allowedFloors: [1, 2, 3, 4], attackDamage: 11, attackWindupMs: 4200, attackDescription: "다음 플레이어 후딜 200ms 증가", specialName: "갈고리 휘감기" }),
  ...
  createEnemyConfig({ id: "ap-devourer", name: "행동력 포식자", tier: "normal", role: "execution", hp: 116, allowedFloors: [7, 8, 9], attackDamage: 20, attackWindupMs: 6900, attackDescription: "AP 1 감소", specialName: "행동력 흡식" }),
  ...
  createEnemyConfig({ id: "palimpsest", name: "붉은 편집장 팔림프세스트", tier: "boss", role: "disruption", hp: 430, allowedFloors: [5], attackDamage: 30, attackWindupMs: 5700, attackDescription: "추가 어절 기믹", specials: [
    { id: "word-storm", name: "어절 폭풍", damage: 45, windupMs: 6900, recoveryMs: 700, description: "추가 어절을 생성합니다." },
    { id: "red-edit", name: "붉은 교정", damage: 55, windupMs: 8100, recoveryMs: 900, description: "플레이어의 입력 규칙을 교정합니다." },
  ] }),
  createEnemyConfig({ id: "thousand-beat-chorus", name: "천 개의 박자 합창체", tier: "boss", role: "pressure", hp: 630, allowedFloors: [10], attackDamage: 20, attackWindupMs: 4500, attackDescription: "대합창은 최대 2회", specials: [
    { id: "grand-chorus", name: "대합창", damage: 30, windupMs: 5700, recoveryMs: 600, description: "대합창을 시작합니다." },
    { id: "crescendo", name: "크레센도", damage: 40, windupMs: 7200, recoveryMs: 800, description: "합창의 박자를 끌어올립니다." },
  ] }),
